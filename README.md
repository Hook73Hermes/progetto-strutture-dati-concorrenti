...
Il progetto confronta sperimentalmente due strategie di sincronizzazione per l'elenco dei subscriber (**RCU vs rwlock_t**), con l'idea di misurare throughput e latenza al variare del numero di publisher/subscriber.

**File**: `pubsub.c` (modulo kernel), `pubsub_ioctl.h` (gestione ioctl, incluso dagli altri file C), `Makefile`.